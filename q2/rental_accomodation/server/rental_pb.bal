...
public isolated client class RentalAccommodationPropertyListResponseCaller {
...
public isolated client class RentalAccommodationSearchPropertyResponseCaller {
    private final grpc:Caller caller;
...
public isolated client class RentalAccommodationBookingCartResponseCaller {
    private final grpc:Caller caller;
...
public isolated client class RentalAccommodationCreateUsersResponseCaller {
    private final grpc:Caller caller;
...
public isolated client class RentalAccommodationPropertyCaller {
    private final grpc:Caller caller;
...
public isolated client class RentalAccommodationBookingConfirmationCaller {
    private final grpc:Caller caller;
...
public isolated client class RentalAccommodationAddPropertyResponseCaller {
    private final grpc:Caller caller;
...
public isolated client class RentalAccommodationPropertyResponseCaller {
    private final grpc:Caller caller;
